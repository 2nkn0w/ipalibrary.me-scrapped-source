...
OUTPUT_FILE = "ipalibrary_source.json"
# Higher threads = faster, but watch out for rate limits. 10-15 is the sweet spot.
MAX_THREADS = 12 
HEADERS = {
...
def decode_download_url(encoded_href):
    ...
    try:
        ...
        # Use regex to find the actual .ipa URL
...
def scrape_app_page(url):
    ...
    try:
        ...
        # 2. Get App Icon (Looking for the rounded image in the main card)
        icon_url = "https://ipalibrary.me/favicon.ico" # Default fallback
        ...
        # 3. Get Developer and Version from 'ipa-developer' divs
        ...
        if download_url:
            # Create a clean bundle ID based on the name
...
def run_scraper():
    ...
    # Step 1: Fetch all app URLs from Sitemap
    try:
    ...
    # Step 3: Filter results and build final JSON
